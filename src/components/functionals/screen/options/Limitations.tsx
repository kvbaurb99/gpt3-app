...
export default function Limitations({isDark}: Props) {
  return (
    <div className='flex flex-col items-center'>
        <div className='flex md:flex-col flex-row items-center gap-4 md:gap-0'>
          <CiWarning className={`${isDark ? 'text-white' : 'text-black'} text-2xl`} />
          <p className={`md:mt-4 ${isDark ? 'text-white' : 'text-black'}`}>Limitations</p>
        </div>
